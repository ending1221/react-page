...
class Cart extends Component {
    ...
    render() {
        ...
        this.state.rate = totalAmount === 0 ? 0 : totalAmount >= 1000 ? 0 : 70;
        ...
        return (
            <div className={style.cart}>
                ...
                {orders.length !== 0 ? (
                    orders.map(
                        (
                            { name, id, src, count, promote_price, variant },
                            index
                        ) => {
                            return (
                ...
                <p>運費: NT {this.state.rate} (全館商品滿千免運)</p>
                <hr />
                <p>消費總額: NT {this.state.rate + totalAmount}</p>
