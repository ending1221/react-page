  ...
  render() {
    ...
    return (
      <div className={style.products}>
        ...
        <img className={style.banner} src={require("./img/ndis.jpg")} />
        <ul>
          {filterList.map(({ name, id, price, promote_price, src }, index) => {
            return (
              <li className={style.card} key={index}>
                ...
                <button onClick={addOrder.bind(this, id)}>加入購物車</button>
              </li>
            );
          })}
